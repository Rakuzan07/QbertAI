...
public class QbertPanel extends JPanel implements KeyListener {
    ...
    public QbertPanel() {
		...
		demoScreenBackground = tk.getImage(this.getClass().getResource("resources"+File.separator+"demo"+File.separator+"QbertRebooted.jpg"));
		...
		for (int i = 0; i < 7; i++)
			pressAnyKey.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"demo"+File.separator+"pak" + (i + 1) + ".png")));
		gm = new GameManager();
	...
	public void loadWorld() {
		if(gm.worldCompleted()) {
			...
			nround= tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+""+gm.getRound()+".png"));
		    nlevel= tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+""+gm.getLevel()+".png"));
			for(int i=0;i<=gm.getLevel();i++) {
				block[i]=tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"block"+gm.getLevel()+"_"+gm.getRound()+"_"+i+".png"));
			}
			change = tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"block"+gm.getLevel()+"_"+gm.getRound()+"m.png"));
			initialQbertIndex=0;
	...
	public void keyPressed(KeyEvent arg0) {
		...
		gameover=tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"gameover.png"));
		gm_d_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenman_right1.png")));
		gm_d_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenman_right2.png")));
		gm_d_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenman_right3.png")));
		gm_d_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenman_right4.png")));
		gm_d_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenman_left1.png")));
		gm_d_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenman_left2.png")));
		gm_d_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenman_left3.png")));
		gm_d_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenman_left4.png")));
		ball.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"ball1.png")));
		ball.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"ball2.png")));
		greenBall.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenball1.png")));
		greenBall.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"greenball2.png")));
		snakeball = new ArrayList<Image>();
		snakeball.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"purpleball1.png")));
		snakeball.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"purpleball2.png")));
		elevator.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"elevator1.png")));
		elevator.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"elevator2.png")));
		elevator.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"elevator3.png")));
		elevator.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"elevator4.png")));
		block=new Image[gm.getLevel()+1];
		deathImage=tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"dead.png"));
		block[1] = tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"block4.png"));
		changeto = tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"changeto.png"));
		row1 = tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"row1.png"));
		row2 = tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"row2.png"));
		change = tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"block3.png"));
		life = tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"q8.png"));
		level= tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"level.png"));
	    round= tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"round.png"));
	    nround= tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+""+gm.getLevel()+".png"));
	    nlevel= tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+""+gm.getRound()+".png"));
	    logo=tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"qbert_logo.png"));
	    d_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"q7.png")));
	    d_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"q8.png")));
	    d_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"q5.png")));
	    d_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"q6.png")));
	    u_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"q3.png")));
	    u_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"q4.png")));
	    u_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"q1.png")));
	    u_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"q2.png")));
	    snake_d_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"enemy1_7.png")));
	    snake_d_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"enemy1_8.png")));
	    snake_d_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"enemy1_5.png")));
	    snake_d_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"enemy1_6.png")));
	    snake_u_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"enemy1_3.png")));
	    snake_u_left.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"enemy1_4.png")));
	    snake_u_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"enemy1_1.png")));
	    snake_u_right.add(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"enemy1_2.png")));
	    block[0]=(tk.getImage(this.getClass().getResource("resources"+File.separator+"play"+File.separator+"block2.png")));
				...
				if(r.nextInt()%10<2)gm.goDownLeft();
				   ...
				   if (p instanceof Ball || p instanceof Snake || p instanceof GreenBall || p instanceof GreenMan) {
					   ...
					   if (p.getState() == Player.Status.D_LEFT) {
						   ...
						   if (ePosition.getY() != blockPosition.get(gm.getBlockIndex(p)).getY() - 16 && p instanceof Snake && !((Snake)p).getStatusHatch()) ePosition.setY(ePosition.getY() + 1); 
						   else if (ePosition.getY() != blockPosition.get(gm.getBlockIndex(p)).getY() - 4)
						   ...
						   else if (blockPosition.get(gm.getBlockIndex(p)).getX() + 8 == ePosition.getX() && blockPosition.get(gm.getBlockIndex(p)).getY() - 4 == ePosition.getY() && (! (p instanceof Snake) || ((p instanceof Snake)&&((Snake)p).getStatusHatch()))) {
							   enemyPosition.put(p, gm.getBlockIndex(p));
					   ...
					   if (p.getState() == Player.Status.D_RIGHT) {
						   if (ePosition.getX() != blockPosition.get(gm.getBlockIndex(p)).getX() + 8)
							   ePosition.setX(ePosition.getX() + 1);
						   if (ePosition.getY() != blockPosition.get(gm.getBlockIndex(p)).getY() - 16 && p instanceof Snake && !((Snake)p).getStatusHatch()) ePosition.setY(ePosition.getY() + 1); 
						   else if (ePosition.getY() != blockPosition.get(gm.getBlockIndex(p)).getY() - 4) ePosition.setY(ePosition.getY() + 1);
						   if (p instanceof Ball) {
							   g.drawImage(ball.get(LIFTED_UP), ePosition.getX() - 1, ePosition.getY() - 1, this);
						   } else if (p instanceof GreenMan) {
							   g.drawImage(getGMImage(p), ePosition.getX() - 1, ePosition.getY() - 1, this);
